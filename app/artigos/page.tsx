...
async function getPost(slug: string) {
  // A query GROQ busca os dados do post, incluindo a URL da imagem principal e o Portable Text 'content'
  const query = `*[_type == "post" && slug.current == "${slug}"][0]{
    ...
    "slug": slug.current // O slug do post
  }`;
...
// Este objeto mapeia os tipos de blocos e marcas do Portable Text para componentes React/HTML
...
// --- O Componente da Página Principal (App Router) ---
    ...
    <>
      ...
      <main className="bg-white py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Seção de Comentários (Hyvor Talk foi removido - adicione outro sistema se quiser) */}
          {/* <section className="mt-12 pt-8 border-t border-gray-200">
            <h2 className="text-2xl font-bold mb-6 text-gray-800">Comentários</h2>
            <div id="seu-sistema-de-comentarios-aqui"></div>
          </section> */}
